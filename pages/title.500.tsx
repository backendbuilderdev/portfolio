...
export default function Title500() {
    return (
        <Head>
            ...
            <title>500: internal server error | Sandeep Pal</title>
            ...
            <meta name="keywords" content="500, internal server error, Sandeep Pal, Portfolio,broken link ,missing page,link not found" />
